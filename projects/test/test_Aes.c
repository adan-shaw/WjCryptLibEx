...
bool TestAes (void)
{
	...
	for (i = 0; i < NUM_TEST_VECTORS; i++)
	{
		...
		if (memcmp (encBlock128, &gTestVectors[i].CipherText128, 16) == 0 && memcmp (decBlock128, &gTestVectors[i].PlainText, 16) == 0 && memcmp (encBlock192, &gTestVectors[i].CipherText192, 16) == 0 && memcmp (decBlock192, &gTestVectors[i].PlainText, 16) == 0 && memcmp (encBlock256, &gTestVectors[i].CipherText256, 16) == 0 && memcmp (decBlock256, &gTestVectors[i].PlainText, 16) == 0)
		{
			// Test vector passed
		}
		else
